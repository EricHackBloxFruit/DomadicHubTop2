...
ImageButton1.Image = "https://create.roblox.com/dashboard/creations/store/127248047905825/"
...
local LogoToggle = Instance.new("ImageLabel")
    ...
    LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(106898136342049)
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "https://create.roblox.com/dashboard/creations/store/127248047905825/";
      Title = "Eric Hub VN", 
